            ...
            it("file.spec.129 cordova.file.*Directory are set", function () {
                ...
                if (cordova.platformId == 'android' || cordova.platformId == 'amazon-fireos') {
                    if (cordova.file.externalApplicationStorageDirectory !== null) {
                        ...
                        // If vendor storage can't be mounted, the cordova.file.vendor* properties are null.
...
exports.defineManualTests = function (contentEl, createActionButton) {
    ...
    var fsRoots = {
        ...
        "android" : "files,files-vendor,documents,sdcard,cache,cache-vendor,root",
        "amazon-fireos" : "files,files-vendor,documents,sdcard,cache,cache-vendor,root",
